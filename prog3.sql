...
WHERE NOT EXISTS
((SELECT PNO FROM PROJECT_H WHERE DNO='5')MINUS(SELECT PNO FROM WORKSON_H       /* This query is wrong!! Find updated query!!*/
WHERE E.SSN=SSN)); 

SELECT D.DNO,D.DNAME,E.NAME ,COUNT(*) AS NOOFEMP 
FROM EMPLOYEE_H E,DEPT1 D 
